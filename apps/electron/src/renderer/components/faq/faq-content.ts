...
export const FAQ_GROUPS: FaqGroup[] = [
  ...
  },
  {
    id: 'discover',
    topic: '发现与社区',
    description: '官方内容、社区讨论与反馈的统一入口。',
    items: [
      {
        question: '「发现」面板是什么？在哪里打开？',
        answer: '「发现」是左侧栏「功能」分组中的统一入口，聚合三个分区：官方精选（视频 / 教程 / 公告 / 外链）、社区讨论（GitHub Discussions 只读浏览）和反馈（Notion 提交）。官方内容由维护者通过内容仓库持续更新。',
        keywords: ['发现', '社区', '官方内容', '入口'],
      },
      {
      ...
      {
        question: '视频是怎么播放的？需要一直联网吗？',
        answer: '首次点击视频会下载到本地缓存（显示进度条），之后播放不再消耗流量；缓存文件保存在 MyYoda 本地数据目录中。下载与播放都经过你配置的代理（如已开启）。',
        keywords: ['视频', '缓存', '下载', '离线'],
      },
      {
        question: '能在应用内直接发帖或回复社区讨论吗？',
        answer: '当前社区讨论在应用内是只读浏览：按问题讨论 / 经验分享 / 公告三个板块查看列表与正文。「回复」「发起讨论」会跳转到浏览器中的 GitHub Discussions 页面完成（需要 GitHub 账号）。匿名浏览受限流影响时，稍后再试或点击刷新。',
        keywords: ['社区', 'GitHub', '发帖', '讨论'],
      },
      {
        question: '「发现」里的反馈和设置里的反馈是同一个吗？',
        answer: '是的。「发现 → 反馈」只是现有 Notion 反馈弹窗的另一个入口，配置与提交路径完全一致；设置 → 帮助 → 意见反馈等原有入口也保持不变。',
        keywords: ['反馈', 'Notion', '入口', '复用'],
      },
    ],
  },
  {
