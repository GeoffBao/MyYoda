...
const GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    summary: '左侧栏「功能 → 发现」聚合官方精选、社区讨论和反馈：看视频学用法，浏览社区经验，遇到问题直接反馈。',
    steps: ['官方精选：视频下载后应用内播放，教程和公告直接阅读，外链跳浏览器', '看到「更新」标记说明有新内容或新版本，点开即已读，侧边栏红点随之消失', '社区讨论按问题讨论 / 经验分享 / 公告三个板块浏览，「回复」「发起讨论」会跳转 GitHub', '反馈直达维护者 Notion 库，附上截图和联系方式更有助于快速定位'],
    example: '打开「发现 → 官方精选」，播放《Agent 的本质到底是什么》了解 Agent 原理；到「社区 → 经验分享」看大家的实践心得，有疑问在浏览器里发起讨论或提交反馈。',
  },
] as const
