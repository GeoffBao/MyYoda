...
type AgentRuntimeRequestHandler = (request: import('@myyoda/shared').AgentRuntimeRequest) => Promise<unknown>
...
export class AgentRuntimeClient {
  ...
  private async handleIncomingRequest(request: import('@myyoda/shared').AgentRuntimeRequest): Promise<void> {
